    ...
    methods: {
        ...
        encode: function (bits) {
            ...
            if (bits.length === 4) {
                ...
                var c2 = this.parity(
                    parseInt(bits[0].data) + parseInt(bits[2].data) + parseInt(bits[3].data) + parseInt(bits[6].data) + parseInt(bits[7].data)
                );
                var c1 = this.parity(
                    parseInt(bits[0].data) + parseInt(bits[1].data) + parseInt(bits[3].data) + parseInt(bits[5].data) + parseInt(bits[7].data)
                );
